...
**Para subir seu próprio ElectrumX:** veja o guia completo em [`docs/ELECTRUMX_SETUP.md`](ELECTRUMX_SETUP.md).
...
| `rustup` was not found (cryptography) | O script instala Rust automaticamente (deploy_wallet v8+); ou: `curl https://sh.rustup.rs -sSf \| sh` |
...
| `No Connection` | O app está OK — o **servidor SPV ElectrumX** não responde. Teste: `python scripts/check_spv_server.py`. Para **instalar seu servidor**: [`docs/ELECTRUMX_SETUP.md`](ELECTRUMX_SETUP.md) |
